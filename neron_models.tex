...
\begin{Satz}\label{thm:abelscheneronmodelle}
  ...
  \begin{proof}[Beweisskizze]
    ...
    \begin{description}
    \item[$A\cong X$] $X$ ist als flaches $R$-Schema
      % ???
      mit zusammenhängender generischer Faser $A_\K$ zusammenhängend.
      % ???
...
\begin{Satz}
  ...
  \begin{proof}[Beweisskizze]
    ...
    Wegen der Néron-Abbildungseigenschaft ist die Kozykelbedingung
...
Bewertungskörper $\K$ mit Bewertungsring $R$.

Einige Aussagen vorweg:
\begin{Satz}
  Sei $W^0$ der glatte Teil des projektiven $R$-Unterschemas
  $W\subset\P_R^n$, das durch eine bzgl. $R$ minimale
  Weierstraßgleichung von $E$ erzeugt wird.
  Das offene $R$-Unterschema $W^0$ der glatten Punkte von $W$ ist ein
  glattes $R$-Gruppenschema, das $E$ erweitert, und die
  Identitätskomponente des Néron-Modells von $E$ über $R$.
