...
\begin{Satz}
  ...
  \begin{proof}
    ...
    \item Sei $X'$ ein weiteres Néron-Modell von $X_\K$.
      ...
      Isomorphismen.
    \item Sei $X_{R'}\coloneqq X\times_R \Spec(R')$ der Basiswechsel
      ...
      $\K'$-Morphismus. 
      \begin{description}
      \item[Eindeutigkeit] Da $\phi_{\K'}'$ ein $\K'$-Morphismus ist,
        gilt $\text{proj}_{\K'}\circ\phi_{\K'}'=\text{proj}_{\K'}$.
        Damit ist $\phi_{\K'}'$ bereits eindeutig bestimmt durch
        \begin{gather*}
          \phi_{\K'}' =
          (\text{proj}_{X_{\K}}\circ\phi_{\K'}') \times \text{proj}_{\K'}
          \colon
          Y_{\K'}'\longto
        ...
        \begin{gather*}
          \phi' =
          (\text{proj}_{X}\circ\phi') \times \text{proj}_{R'}
          \colon
          Y'\longto
          X_{R'}=X\times_{R}\Spec(R')
        \end{gather*}
        Für den $\K$-Morphismus $(\text{proj}_{X_{\K}}\circ\phi_{\K'}')\colon
        Y_{\K'}'\to X_{\K}$ gilt die Eindeutigkeit der
        Néron-Abbildungseigenschaft, weshalb
        $(\text{proj}_{X}\circ\phi')$ und damit $\phi'$ eindeutig
        bestimmt ist.
      \item[Existenz] 
        ...
        $ \phi_{\K}\colon Y_{\K'}'\overset{\phi_{\K'}'}\longto X_{\K'}
        \overset{\text{proj}}\longto X_{\K}$
        mit der Néron-Abbildungseigenschaft zu einem eindeutigen
        $R$-Morphismus
        \begin{gather*}
          \phi\colon Y'\longto X
        \end{gather*}
        erweitern.
        So erhalten wir kanonisch einen $R'$-Morphismus $\phi'$
        \begin{center}
          \begin{tikzcd}
            Y'
            \arrow[drr, bend left, "\pi_{Y'}"]
            \arrow[ddr, bend right, "{\phi}"]
            \arrow[dr, dashed, "{\exists!\phi'}"]\\
            & X\times_{R} R'
            \arrow[dr, phantom, "\ulcorner", very near start]
            \arrow[r, "\text{proj}"]\arrow[d, "\text{proj}"]
            & \Spec(R')\arrow[d]\\
            & X \arrow[r]
            & \Spec(R)
          \end{tikzcd}
        ...
        \begin{align*}
          \phi'|_{Y_{\K'}'}
          &= \phi|_{Y_{\K'}'}\times\pi|_{Y_{\K'}'}\\
          &= \phi_{\K}\times \pi_{\Spec(\K')}\\
          &= (\text{proj}_X\circ\phi_{\K'}') \times (\text{proj}_{\Spec(\K')}\circ\phi_{\K'}')
          = \phi_{\K'}'
        \end{align*}
      \end{description}
    \end{enumerate}
...
\begin{Bemerkung}\label{gruppenschemaerweiterung}
...
\begin{Bemerkung}\label{nerongruppenschemaglatt}
  ...
  \begin{proof}[Beweisskizze]
    ...
    Dies zeigt, dass $\sigma_0$ bereits geschlossene Immersion ist
...
\begin{Bemerkung}[Spezialfall elliptische Kurven]
  ...
  \ref{gruppenschemaerweiterung} und \ref{nerongruppenschemaglatt} ein
