...
\begin{Lemma}\label{thm:rationalzumorphismus}
  ...
  $\phi\colon Y\dra G$ eine $R$-rationale Abbildung, deren
  Definitionsbereich dicht in jeder Faser von $Y$ liegt.
  Dann gilt:
...
\begin{Satz}
  ...
  \begin{proof}[Beweisskizze]
    ...
    Unterschemastruktur, da $A_\K$ reduziert ist nach
...
\begin{Satz}\label{thm:exneronmodelle}
  ...
  (d.\,h. eigentliches, reguläres, integrales, projektives,
...
\begin{Lemma}\label{thm:fallstriktehenselisierung}
  ...
  \begin{proof}
    ...
    \item Also kann $\phi(\eta_Z)$ nicht in $E$ liegen. Ansonsten
      ...
      $\eta_Z$ definiert.
      % C integral, urbilder dichter Mengen dicht
