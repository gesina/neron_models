...
Idee Néron-Modell:
\begin{itemize}
\item Schema über Ring statt Körper
\item Gruppenstruktur soll erweitert werden
\item Schnitte sollen erweitert werden
\end{itemize}

Inhalt:
\begin{itemize}
\item Nötiges zu Gruppenschemata
\item Def. + grundlegende Eigenschaften Néron-Modell
\item Abelsche Varietäten: Welcher Teil des Gruppenschemas ist
  abelsch?
\item Spezialfall elliptische Kurven: Vom Weierstraßmodell zum
  Néron-Modell (insb. Existenz)
\end{itemize}

Benötigte Begriffe:
\begin{itemize}
\item Grundbegriffe Schemata
\item eigentlich, separiert, Bewertungskriterium
\item Dedekindring, diskreter Bewertungsring
\end{itemize}
...
\chapter{Weierstraßmodelle}\label{chap:weierstraßmodell}
...
\begin{Satz}\label{thm:exarithfl}
  ...
  \begin{proof}
    Aus \autoref{chap:weierstraßmodell} wissen wir, dass wir zu $E_\K$
