...
\begin{Definition}[arithmetische Fläche]
  ...
  und jede spezielle Faser $X_s$ über einem geschlossenen Punkt
...
\begin{Lemma}\label{thm:arithflschnittbilderglatt}
  ...
  \begin{proof}
    ...
    $\phi|_{\Spec(\k(\p))}$ geschlossen in $X_\p$.
...
In diesem Abschnitt sei $R$ immer ein Dedekindring mit perfekten
Restklassenkörpern, $\K$ sein Quotientenkörper und $C_\K$ eine
...
\begin{Satz}[{\cite[Theorem 9.3.21]{liu}}]\label{thm:exminmodell}
  ...
  \begin{proof}[Beweisskizze]
    ...
    mithilfe der Bedingung an den Genus der generischen Faser gezeigt
    werden.
