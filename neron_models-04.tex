...
% DISKRIMINANTE
Zu einer Weierstraßgleichung ist die Diskriminante und die
...
\begin{Satz}\label{thm:weierstrassglatt}
...
\begin{Satz}\label{thm:neronmausweierstrassgl}
  ...
  \begin{proof}
    ...
    $W\times_R R_s$ für die abgeschlossenen Punkte ${s\in\Spec(R)}$
